...
//Constructor
        SDS3D::SDS3D()//constructor
        {
           Reset();
        }
        

         SDS3D::~SDS3D()//destructor
        {
         ...
         void SDS3D::Reset()//reset internal value to orignale status
             {
        ...
        void SDS3D::Deallocate()//destructor
        {
            //deallocate memory
            if(First!=NULL)delete [] First;First=NULL;
            if(Next!=NULL)delete [] Next;Next=NULL;
            if(idStore!=NULL)delete [] idStore;idStore=NULL;
            
            //reset some value
            Reset();
        }  

        int SDS3D::BuildSDS(Coord3D*inputp,  int inNp) {
...
/////////////////////////////////////////////////////////////////////
        ...
        void  SDS3D::SearchClosest(Coord3D *pk, int* idc, double* mindist) {/// Find the closest point using built Leaves
            //p reference point
            //qp query point
            // idc id closest
...
//              SearchKClosest
/////////////////////////////////////////////////////////////////////
        void  SDS3D::SearchKClosest(Coord3D *pk, int* idc, double* distances, int k) {/// Find the closest point using built Leaves
            //p reference point
            //qp query point
            // idc id closest
            // mindist the distance from the closest
...
/////////////////////////////////////////////////////////////////////
        ...
        void  SDS3D::SearchRadius(Coord3D* pk, double r)
        ...
        void SDS3D::RemovePoint(int idp) {
        ...
        void SDS3D::SearchClosestExclusive(Coord3D *pk, int* idc, double* mindist, int sp) {/// Find the closest point using built Leaves the point id must be different from sp
            //p reference point
            //qp query point
            // idc id closest
            // mindist the distance from the closest
...
idp=First[id];
        ...
        int SDS3D::EmptyBallTest(Coord3D* pk, double sqrdist)
...
/////////////////////////////////////////////////////////////////////
        void  SDS3D::SearchKClosestExclusive( Coord3D *pk, int* idc, double* distances, int k, int sp) {/// Find the closest point using built Leaves
            //p reference point
            //qp query point
            // idc id closest
            // mindist the distance from the closest
...
//              mexPrintf("Dopo la prima foglia");
        ...
        void SDS3D::SearchCuboid( double* Cuboid) {
...
/////////////////////////////////////////////////////////////////////
        ...
        void  SDS3D::SearchRadiusExclusive( Coord3D* pk, double r,int sp)
        ...
        void SDS3D::GetPointsInRange(double* Cuboid) {
...
//include without test points inside the cuboid
          ...
          void  SDS3D::PrintStatistics()//prints statistics for the data structure
              {
                int i;
                float empty=0;

                for(i=0;i<Nb;i++){if(First[i]<0){ empty++;}}

           

                cout<<"Empty percentage: "<<((empty/(float)Nb)*100)<<"%"<<endl;
                cout<<"Mean density: "<<(float)Np/((float)Nb-empty)<<endl;
